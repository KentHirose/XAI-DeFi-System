...
module.exports = async function(callback) {
    ...
    // 明示的に許可する必要があります。
    // farmTokenが私たちに代わってx量のMyTokenを送金することを許可します。
    await myToken.approve(farmToken.address, web3.utils.toWei('1', 'ether'));
    ...
    await farmToken.deposit(web3.utils.toWei('1', 'ether'));
    console.log('*** My Token ***')
